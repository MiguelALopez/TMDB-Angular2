...
export class SerieService {
  ...
  /**
   * This function obtain the details of a specific serie, for more information of the api TMDB
   * https://developers.themoviedb.org/3/tv/get-tv-details
   * @param id: This is the ID of the serie
  ...
  /**
   * This function obtain the credits of a specific serie, for more information of the api TMDB
